...
public class CartPage {
	...
	public WebElement amazonPaybtn(){
		...
		return	WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//p[text()='Or select another way to pay:']//following::div[1]"), 60);
		//return SeleniumFunction.expandRootElement(driver, element);
	}
	...
	public WebElement emailTextbox() {
		...
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//input[@id='txtExistingEmailAddress']"), 60);
	}
	...
	public WebElement signinButton() {
		...
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//button[@id='btnHaveAnAccount']"), 60);
	}	
	...
	public String shipping() {
		return SeleniumFunction.getText(WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//div[text()='Shipping']/following-sibling::div[1]"), 60));
	}

	public String tax() {
		return SeleniumFunction.getText(WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//div[text()='Tax: ']/following-sibling::div[1]"), 60));
	}
