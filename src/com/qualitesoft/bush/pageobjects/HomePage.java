...
public class HomePage {
	...
	public WebElement searchTextField() {
		...
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"top-search-form\"]/input"), 10);
	}
	public WebElement HomeSqsearchTextField() {
		
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//input[contains(@name,'Search')]"), 10);
		
	}	
	public WebElement bushicon() {
		
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"logo\"]/img"), 30);
    ...
    public WebElement furniturelink() {
		...
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"navigation\"]/div/div/div/nav/div/ul/li[1]/a"), 10);
	}
	...
	public WebElement diningChairs() {
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"navigation\"]/div/div/div/nav/div/ul/li[1]/div/div/div[1]/ul/li/ul/li[7]/a"), 30);
	}
	...
	public WebElement sortDropdown() {
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"filter-dropdown\"]"), 30);
	...
	public WebElement Design() {
		...
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"collapseSeatType\"]/ul/li[1]/a"), 30);
	}
...
public WebElement under$100Filter() {
		
		//return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id='collapsePrice']/ul/li[1]/label"), 30);
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"collapsePrice\"]/ul/li[1]/a"), 30);
	}
	...
	public WebElement armChair() {
		...
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"collapseSeatType\"]/ul/li[2]/a"), 10);
	}
