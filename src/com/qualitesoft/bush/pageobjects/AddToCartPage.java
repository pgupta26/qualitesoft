...
public class AddToCartPage {
	...
	public WebElement quantityDropdownHome() {
		...
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"add-to-cart\"]/div[2]/div/input"),10);

	}
	public WebElement addToCartButton() {

		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"add-to-cart-btn\"]"), 30);
	}
