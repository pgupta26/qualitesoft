...
public class CarrierMarkups {
	...
	/*public String dollarvalue="132";
	public String percentagevalue="130";
	public String incvalue="1170";
	public String decvalue="1171";*/
	...
	public WebElement clkUpdateBtn(){
		return WaitTool.waitForElementPresentAndDisplay(driver, updatebtn, 60);
	}
}
