...
public class TestManageOrders extends InitializeTest {
	...
	public void testRequestCancellationAndCloneOrReQuoteButton1() {
		...
		if(i == 2) {
			Assert.assertTrue(WaitTool.isElementPresentAndDisplay(driver, By.xpath("//a[text()='Cancel']")));
		} else if(i == 3) {
			Assert.assertTrue(WaitTool.isElementPresentAndDisplay(driver, By.xpath("//a[text()='Clone']")));
		} else if(i == 4) {
			Assert.assertTrue(WaitTool.isElementPresentAndDisplay(driver, By.xpath("//a[text()='Re-Quote']")));
		}
