...
public class TestQuickQuoteStg extends InitializeTest {
	...
	public void testGetQuote() {
		...
		Xls_Reader manageInvoiceTestData = new Xls_Reader("testdata/FCfiles/"+ env +"/ManageInvoiceTestData.xlsx");
		...
		Xls_Reader secondaryInvoice = new Xls_Reader("testdata/FCfiles/"+ env +"/SecondaryInvoiceTemplate.xlsx");
