...
public class TestUserIsAbleToCreatePalletizedSkuThenAddingAnotherProduct extends InitializeTest{

	@Test
	public void testUserIsAbleToCreatePalletizedSkuThenAddingAnotherProduct() {
		...
		//add additional cartons
		SeleniumFunction.click(quickQuote.addadditionalItem());
		commonOps.addPalletContents(xr, 15, 2);
