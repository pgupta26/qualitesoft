...
public class TestSubmitCustomQuote extends InitializeTest {
	...
	public void testSubmitCustomQuote() {
		...
		Select deliveryFrequency = new Select(driver.findElement(By.xpath("//*[@id=\"shipment-review\"]/div[1]/div[3]/div/div[3]/div[1]/select")));
		if(i == 5) {
		...
		SeleniumFunction.click(WaitTool.waitForElementPresentAndDisplay(driver, By.id("addCustomQuote"), 30));
