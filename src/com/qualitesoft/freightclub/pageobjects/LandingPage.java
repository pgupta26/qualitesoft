...
public class LandingPage {
	...
	public WebElement pallerRequired() {		
		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//div[text()='No Pallet Required' and @class='item']/parent::div"), 30);		
	} 
	...
	public WebElement cartoonlength() {

		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"product-cartons-table\"]/tbody/tr/td[3]/div[1]/input"), 30);
	}
	public WebElement cartoonwidth() {

		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"product-cartons-table\"]/tbody/tr/td[3]/div[2]/input"), 30);
	}
	public WebElement cartoonheight() {
	...
	public WebElement safeCategory() {

		return WaitTool.waitForElementPresentAndDisplay(driver, By.xpath("//*[@id=\"product-cartons-table\"]/tbody/tr/td[4]/select/option[16]"), 30);
	}
