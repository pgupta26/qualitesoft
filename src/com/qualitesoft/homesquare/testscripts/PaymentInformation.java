...
import com.qualitesoft.homesquare.pageobjects.PaymentInformationPage;
import com.qualitesoft.homesquare.pageobjects.PaypalCheckout;
...
public class PaymentInformation extends InitializeTest {
	...
	public void testPaypal() throws ParseException {
		...
		WaitTool.sleep(2);
		if(suiteName.contains("Homesquare")) {
			Assert.assertEquals(payPalCheckOut.infoMessage().trim(), "This is the address provided by Homesquare. You can change it on the Homesquare site.");
		} else {
