...
public class TestDisapproveTheBoard extends InitializeTest{
	
	@Test
	public void testDisapproveTheBoard(){
		
		BoardApprovalPage boardApprovalPage = new BoardApprovalPage(driver);
		SeleniumFunction.select(boardApprovalPage.selectDropdown(), "Only Approved");
		...
		SeleniumFunction.click(boardApprovalPage.disapproveButton());
		WaitTool.sleep(4);
		ScreenShot.takeScreenShot(driver, "BoardDisapproved");
	}
